...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // alarmViewModel.update(adapter.getAlarmAt(viewHolder.getAdapterPosition()).setState("2"));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_ALARM_REQUEST && resultCode == RESULT_OK) {
            ...
            String alarmTimeInMilli = data.getStringExtra(AddEditAlarmActivity.EXTRA_ALARM_TIME_IN_MILLIS);

            Alarm alarm = new Alarm(title, time, date, state, alarmTimeInMilli);
